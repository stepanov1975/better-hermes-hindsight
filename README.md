...
Use the [recall-quality evaluator](docs/recall-quality-evaluation.md) for strict synthetic fixtures
or privacy-preserving read-only comparison of the configured baseline with
