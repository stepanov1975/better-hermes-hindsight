...
- Make recall formatting linear in emitted JSONL bytes, reject oversized result collections, and apply
  one deadline across query projection, network/decode, redaction, and formatting.
